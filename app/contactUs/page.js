  ...
  return (
    <div className="flex flex-col mb-[50px] md:flex-row max-w-[1100px] gap-[25px] m-auto mt-[100px] px-[25px] items-center">
        <div className="w-[100%] md:w-[50%] flex flex-col gap-[15px]">
            ...
            <p className="text-md">Feel free to reach out on this page or through another form of communication.</p>
            <div className="flex flex-row items-center text-lg"><FontAwesomeIcon className="text-4xl text-driftwood-700" icon={faPhone} /><p className="pl-[15px]">(123) 456 - 7890</p></div>
            <div className="flex flex-row items-center text-lg"><FontAwesomeIcon className="text-4xl text-driftwood-700" icon={faEnvelope} /><p className="pl-[15px]">happypaws@gmail.com</p></div>
            <div className="flex flex-row items-center text-lg"><FontAwesomeIcon className="text-4xl text-driftwood-700" icon={faLocationDot} /><div className="pl-[15px]"><p>123 N Linden Street,</p><p>West Lafayette, IN, 47906</p></div></div>
        </div>
        <div className="w-[100%] md:w-[50%] shadow-all-over rounded-[20px]">
